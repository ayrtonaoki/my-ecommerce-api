...
RSpec.describe Coupon, type: :model do
  ...
  it 'can not have past due_date' do
  ...
  context 'on #validate_use!' do
    ...
    it 'raise InvalidUse when it is overdue' do
    ...
    it 'raise InvalidUse when it is inactive' do
    ...
    it 'returns true when it is on date and active' do
